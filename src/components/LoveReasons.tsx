...
const REASONS = [
  ...
  "Mi negra, tu risa es mi sonido favorito en el mundo.",
  "Me haces querer ser una mejor persona cada día.",
  "Tienes el corazón más generoso que conozco.",
  "Bellota, contigo cualquier plan es el plan perfecto.",
  "Simplemente… eres tú, mi bombón de chocolate. Y eso lo es todo.",
